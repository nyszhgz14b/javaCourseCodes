...
public final class Rpcfx {
    ...
    public static <T> T create(final Class<T> serviceClass, final String url, Filter... filters) {
        ...
        enhancer.setCallback(new RpcfxMothedInterceptor(serviceClass,url,filters));
       // return (T) Proxy.newProxyInstance(Rpcfx.class.getClassLoader(), new Class[]{serviceClass}, new RpcfxInvocationHandler(serviceClass, url, filters));
        return (T) enhancer.create();
    }
    public static class RpcfxMothedInterceptor implements MethodInterceptor{
        ...
        public <T> RpcfxMothedInterceptor(Class<T> serviceClass, String url, Filter... filters) {
        ...
        private RpcfxResponse post(RpcfxRequest req, String url) throws IOException, URISyntaxException {
           ...
           /* OkHttpClient client = new OkHttpClient();
            ...
            NettyClient nettyClient = new NettyClient(uri.getHost(), uri.getPort(),url, reqJson);
            String respJson = nettyClient.start();
